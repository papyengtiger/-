...
export class Battle {
  ...
  case SpeciesId.PHIONE:
  case SpeciesId.MANAPHY:
  ...
  case SpeciesId.ETERNATUS:
    if (pokemon.getFormKey() === SpeciesFormKey.ETERNAMAX) {
      return "battle_legendary_eternamax_eternatus";
    }
    return "battle_legendary_eternatus";
  ...
  case SpeciesId.IRON_CROWN:
    return "battle_legendary_paradox";
  ...
  case SpeciesId.MONSTERY:
  case SpeciesId.MYSTERY_GATE:
    return "Battle_Mystery_Monster";
  default:
    if (pokemon.species.legendary) {
      return "battle_legendary_pokemon";
    }
    return "battle_legendary_pokemon";
          }
        }
