...
new SpeciesFormChange(SpeciesId.NECROZMA, "ultra", "dawn-wings", new SpeciesFormChangeMoveLearnedTrigger(MoveId.LIGHT_THAT_BURNS_THE_SKY), false, new SpeciesFormChangeCondition(() => globalScene.gameMode.isDaily !== true)),
...
new SpeciesFormChange(SpeciesId.NECROZMA, "ultra", "dusk-mane", new SpeciesFormChangeMoveLearnedTrigger(MoveId.LIGHT_THAT_BURNS_THE_SKY), false, new SpeciesFormChangeCondition(() => globalScene.gameMode.isDaily !== true))
  ],
  [SpeciesId.MELMETAL]: [
