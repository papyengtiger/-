...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [SpeciesId.MIENFOO]: [
    new SpeciesEvolution(SpeciesId.MIENSHAO, 40, null, null)
  ],
  [SpeciesId.GOLETT]: [
    new SpeciesEvolution(SpeciesId.GOLURK, 33, null, null)
  ],
  [SpeciesId.PAWNIARD]: [
    new SpeciesEvolution(SpeciesId.BISHARP, 32, null, null)
  ],
  [SpeciesId.BISHARP]: [
    new SpeciesEvolution(SpeciesId.KINGAMBIT, 1, EvolutionItem.LEADERS_CREST, null, SpeciesWildEvolutionDelay.VERY_LONG)
  ],
  [SpeciesId.RUFFLET]: [
    new SpeciesEvolution(SpeciesId.HISUI_BRAVIARY, 40, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}),
    new SpeciesEvolution(SpeciesId.BRAVIARY, 40, null, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DAY]})
  ],
  [SpeciesId.VULLABY]: [
    new SpeciesEvolution(SpeciesId.MANDIBUZZ, 40, null, null)
  ],
  [SpeciesId.DEINO]: [
  ...
  [SpeciesId.LARVESTA]: [
    new SpeciesEvolution(SpeciesId.VOLCARONA, 35, null, null)
  ],
  [SpeciesId.CHESPIN]: [
  ...
  [SpeciesId.COSMOEM]: [
    new SpeciesEvolution(SpeciesId.SOLGALEO, 1, {key: EvoCondKey.TIME, time: [TimeOfDay.DAWN, TimeOfDay.DAY]}, null, SpeciesWildEvolutionDelay.VERY_LONG),
    new SpeciesEvolution(SpeciesId.LUNALA, 1, {key: EvoCondKey.TIME, time: [TimeOfDay.DUSK, TimeOfDay.NIGHT]}, null, SpeciesWildEvolutionDelay.VERY_LONG)
  ],
  [SpeciesId.MELTAN]: [
  ...
  [SpeciesId.CHANSEY]: [
    new SpeciesEvolution(SpeciesId.BLISSEY, 1, null, {key: EvoCondKey.FRIENDSHIP, value: 160}, SpeciesWildEvolutionDelay.LONG)
  ],
  [SpeciesId.PICHU]: [
  ...
  [SpeciesId.HAPPINY]: [
    new SpeciesEvolution(SpeciesId.CHANSEY, 1, EvolutionItem.OVAL_STONE, null, SpeciesWildEvolutionDelay.SHORT)
  ],
  [SpeciesId.MUNCHLAX]: [
