...
export class Arena {
  ...
  trySetExclusiveWeather(weather: WeatherType, ignoreAnim = false, user?: Pokemon, force = false): boolean {
    if (!force && !this.canSetWeather(weather)) {
      return false;
    }
    ...
    globalScene
      ...
      .filter(p => p.isOnField())
      .map(pokemon => {
        pokemon.findAndRemoveTags(t => "weatherTypes" in t && !(t.weatherTypes as WeatherType[]).includes(weather));
        applyAbAttrs("PostWeatherChangeAbAttr", { pokemon, weather });
      });
  ...
  trySetExclusiveTerrain(terrain: TerrainType, ignoreAnim = false, user?: Pokemon, force = false): boolean {
    if (!force && !this.canSetTerrain(terrain)) {
      return false;
    }
    ...
    globalScene
      ...
      .filter(p => p.isOnField())
      .map(pokemon => {
        pokemon.findAndRemoveTags(t => "terrainTypes" in t && !(t.terrainTypes as TerrainType[]).includes(terrain));
        applyAbAttrs("PostTerrainChangeAbAttr", { pokemon, terrain });
        applyAbAttrs("TerrainEventTypeChangeAbAttr", { pokemon });
      });
...
public getAllFieldPokemons(): Pokemon[] {
  ...
  getBgmLoopPoint(): number {
    switch (this.biomeType) {
      ...
      case BiomeId.SNOWY_FOREST:
        return 3.047;
      case BiomeId.MAGMA_CAVERN:
        return 0.0;
      case BiomeId.LAVA_LAKE:
        return 0.0;
      case BiomeId.BLAZE_FIELD:
        return 0.0;
      case BiomeId.INFERNO_FOREST:
        return 0.0;
      case BiomeId.SPA:
        return 0.0;
      case BiomeId.RIVER:
        return 0.0;
      case BiomeId.LOG_CAVE:
        return 0.0;
      case BiomeId.GREEN_MOUNTAIN:
        return 0.0;
      case BiomeId.SPARK_CAVE:
        return 0.0;
      case BiomeId.LIGHTNING_FIELD:
        return 0.0;
      case BiomeId.THUNDER_MOUNTAIN:
        return 0.0;
      case BiomeId.GLACIER:
        return 0.0;
      case BiomeId.SNOW_MOUNTAIN:
        return 0.0;
      case BiomeId.SNOWY_FIELD:
        return 0.0;
      case BiomeId.GLACIAL_LAKE:
        return 0.0;
      case BiomeId.POLLUTED_CAVE:
        return 0.0;
      case BiomeId.POLLUTED_RIVER:
        return 0.0;
      case BiomeId.SEWER:
        return 0.0;
      case BiomeId.AMUSEMENT_PARK:
        return 0.0;
      case BiomeId.CRYSTAL_CAVE:
        return 0.0;
      case BiomeId.CASTLE:
        return 0.0;
      case BiomeId.STAR_MOUNTAIN:
        return 0.0;
      case BiomeId.DARK_FOREST:
        return 0.0;
      case BiomeId.BLACK_FIELD:
        return 0.0;
      case BiomeId.ABANDONED_CASTLE:
        return 0.0;
      case BiomeId.GHOST_SHIP:
        return 0.0;
      case BiomeId.BLACK_MOUNTAIN:
        return 0.0;
      case BiomeId.DARK_FOREST:
        return 0.0;
      case BiomeId.DESERTED_HOUSE:
        return 0.0;
      case BiomeId.SKY:
        return 0.0;
      case BiomeId.VORTEX_CAVE:
        return 0.0;
      case BiomeId.FAIRY_FOREST:
        return 0.0;
      case BiomeId.SAND_CAVE:
        return 0.0;
      case BiomeId.CANYON:
        return 0.0;
      case BiomeId.BAMBOO_FOREST:
        return 0.0;
      case BiomeId.WYVERN_MOUNTAIN:
        return 0.0;
      case BiomeId.DRAGON_TEMPLE:
        return 0.0;
      case BiomeId.DRAGON_FOREST:
        return 0.0;
      case BiomeId.DRAKE_LAKE:
        return 0.0;
      case BiomeId.SHARP_FIELD:
        return 0.0;
